...
## Purpose
Plans multi-step missions with goals, checkpoints, and completion criteria.

## Files to create later
- src/v108_mission_planner.py
- scripts/check_v108_mission_planner.py
- scripts/v108_mission_planner_demo.py
