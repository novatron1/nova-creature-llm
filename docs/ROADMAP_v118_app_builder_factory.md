...
## Purpose
Extended app builder. Generates multi-file projects from templates.

## Files to create later
- src/v118_app_builder_factory.py
- scripts/check_v118_app_builder_factory.py
- scripts/v118_app_builder_factory_demo.py
