...
## Purpose
Benchmark for robot simulation accuracy.

## Files to create later
- src/v105_robot_simulation_benchmark.py
- scripts/check_v105_robot_simulation_benchmark.py
- scripts/v105_robot_simulation_benchmark_demo.py
