...
## Purpose
Content creation assistant. Suggests topics, outlines, and publishing plans.

## Files to create later
- src/v119_content_creator_brain.py
- scripts/check_v119_content_creator_brain.py
- scripts/v119_content_creator_brain_demo.py
