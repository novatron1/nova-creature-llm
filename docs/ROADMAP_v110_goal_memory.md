...
## Purpose
Tracks active and completed goals. Links to learning loop and training pipeline.

## Files to create later
- src/v110_goal_memory.py
- scripts/check_v110_goal_memory.py
- scripts/v110_goal_memory_demo.py
