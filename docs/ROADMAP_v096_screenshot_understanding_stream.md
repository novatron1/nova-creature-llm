# V096 Screenshot Understanding Stream

## Purpose
Vision/Screenshot understanding stream. Captures screen observations and extracts lessons.

## Files to create later
- src/v096_screenshot_understanding_stream.py
- scripts/check_v096_screenshot_understanding_stream.py
- scripts/v096_screenshot_understanding_stream_demo.py
