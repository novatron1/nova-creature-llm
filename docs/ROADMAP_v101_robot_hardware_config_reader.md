...
## Purpose
Reads real robot hardware configuration when available. Simulation-only by default.

## Files to create later
- src/v101_robot_hardware_config_reader.py
- scripts/check_v101_robot_hardware_config_reader.py
- scripts/v101_robot_hardware_config_reader_demo.py
