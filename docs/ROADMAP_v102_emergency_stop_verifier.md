...
## Purpose
Verifies emergency stop is connected and functional before any real movement.

## Files to create later
- src/v102_emergency_stop_verifier.py
- scripts/check_v102_emergency_stop_verifier.py
- scripts/v102_emergency_stop_verifier_demo.py
