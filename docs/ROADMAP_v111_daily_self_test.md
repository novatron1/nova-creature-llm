...
## Purpose
Runs self-tests daily. Reports health and benchmar scores. Alerts on regression.

## Files to create later
- src/v111_daily_self_test.py
- scripts/check_v111_daily_self_test.py
- scripts/v111_daily_self_test_demo.py
