# V099 File Folder Visual Inspector

## Purpose
Visual inspector for project file trees and folder structures.

## Files to create later
- src/v099_file_folder_visual_inspector.py
- scripts/check_v099_file_folder_visual_inspector.py
- scripts/v099_file_folder_visual_inspector_demo.py
