...
## Purpose
Maps safe movement zones. Blocks movement outside defined zone.

## Files to create later
- src/v104_safe_movement_zone_mapper.py
- scripts/check_v104_safe_movement_zone_mapper.py
- scripts/v104_safe_movement_zone_mapper_demo.py
