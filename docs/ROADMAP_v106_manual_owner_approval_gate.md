...
## Purpose
Owner must explicitly approve before any real robot movement command.

## Files to create later
- src/v106_manual_owner_approval_gate.py
- scripts/check_v106_manual_owner_approval_gate.py
- scripts/v106_manual_owner_approval_gate_demo.py
