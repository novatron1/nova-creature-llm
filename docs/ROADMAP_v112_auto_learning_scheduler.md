# V112 Auto Learning Scheduler

## Purpose
Schedules learning loop runs. Does not train without approval.

## Files to create later
- src/v112_auto_learning_scheduler.py
- scripts/check_v112_auto_learning_scheduler.py
- scripts/v112_auto_learning_scheduler_demo.py
