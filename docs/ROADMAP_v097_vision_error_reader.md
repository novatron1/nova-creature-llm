# V097 Vision Error Reader

## Purpose
Reads error messages from screenshots. Classifies errors and logs to mistake memory.

## Files to create later
- src/v097_vision_error_reader.py
- scripts/check_v097_vision_error_reader.py
- scripts/v097_vision_error_reader_demo.py
