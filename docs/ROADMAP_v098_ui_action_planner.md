# V098 Ui Action Planner

## Purpose
Plans UI actions (click, scroll, type) based on visual observations.

## Files to create later
- src/v098_ui_action_planner.py
- scripts/check_v098_ui_action_planner.py
- scripts/v098_ui_action_planner_demo.py
