...
## Purpose
Business assistant for studio projects. Suggests invoices, timelines, and clients.

## Files to create later
- src/v115_studio_business_assistant.py
- scripts/check_v115_studio_business_assistant.py
- scripts/v115_studio_business_assistant_demo.py
