...
## Purpose
Reads sensor feedback (distance, IMU, battery) in simulation. Prepares for real sensor input.

## Files to create later
- src/v103_sensor_feedback_loop.py
- scripts/check_v103_sensor_feedback_loop.py
- scripts/v103_sensor_feedback_loop_demo.py
