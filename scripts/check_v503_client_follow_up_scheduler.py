#!/usr/bin/env python3
"""Check v503_client_follow_up_scheduler."""
...
def main():
    print(f"Nova v503_client_follow_up_scheduler -- Checker\n")
    c(Path(ROOT/"src"/"v503_client_follow_up_scheduler.py").exists(), "src exists")
