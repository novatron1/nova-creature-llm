#!/usr/bin/env python3
"""Check v502_text_message_draft_brain."""
...
def main():
    print(f"Nova v502_text_message_draft_brain -- Checker\n")
    c(Path(ROOT/"src"/"v502_text_message_draft_brain.py").exists(), "src exists")
