#!/usr/bin/env python3
"""Check v423_beat_license_negotiation."""
...
def main():
    print(f"Nova v423_beat_license_negotiation -- Checker\n")
    c(Path(ROOT/"src"/"v423_beat_license_negotiation.py").exists(), "src exists")
