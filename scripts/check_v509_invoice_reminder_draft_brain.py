#!/usr/bin/env python3
"""Check v509_invoice_reminder_draft_brain."""
...
def main():
    print(f"Nova v509_invoice_reminder_draft_brain -- Checker\n")
    c(Path(ROOT/"src"/"v509_invoice_reminder_draft_brain.py").exists(), "src exists")
