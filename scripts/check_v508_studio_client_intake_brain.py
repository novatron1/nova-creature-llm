#!/usr/bin/env python3
"""Check v508_studio_client_intake_brain."""
...
def main():
    print(f"Nova v508_studio_client_intake_brain -- Checker\n")
    c(Path(ROOT/"src"/"v508_studio_client_intake_brain.py").exists(), "src exists")
    r = intake_client()
