#!/usr/bin/env python3
"""Check v500_internet_research_report."""
...
def main():
    print(f"Nova v500_internet_research_report -- Checker\n")
    c(Path(ROOT/"src"/"v500_internet_research_report.py").exists(), "src exists")
