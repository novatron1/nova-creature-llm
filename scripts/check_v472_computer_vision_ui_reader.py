#!/usr/bin/env python3
"""Check v472_computer_vision_ui_reader."""
...
def main():
    print(f"Nova v472_computer_vision_ui_reader -- Checker\n")
    c(Path(ROOT/"src"/"v472_computer_vision_ui_reader.py").exists(), "src exists")
    r = read_ui()
