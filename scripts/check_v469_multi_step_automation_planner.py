#!/usr/bin/env python3
"""Check v469_multi_step_automation_planner."""
...
def main():
    print(f"Nova v469_multi_step_automation_planner -- Checker\n")
    c(Path(ROOT/"src"/"v469_multi_step_automation_planner.py").exists(), "src exists")
    r = plan_automation()
