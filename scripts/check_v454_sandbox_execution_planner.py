#!/usr/bin/env python3
"""Check v454_sandbox_execution_planner."""
...
def main():
    print(f"Nova v454_sandbox_execution_planner -- Checker\n")
    c(Path(ROOT/"src"/"v454_sandbox_execution_planner.py").exists(), "src exists")
