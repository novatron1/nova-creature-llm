#!/usr/bin/env python3
"""Check v513_long_professional_reply_brain."""
...
def main():
    print(f"Nova v513_long_professional_reply_brain -- Checker\n")
    c(Path(ROOT/"src"/"v513_long_professional_reply_brain.py").exists(), "src exists")
