#!/usr/bin/env python3
"""Check v482_source_reliability_scorer."""
...
def main():
    print(f"Nova v482_source_reliability_scorer -- Checker\n")
    c(Path(ROOT/"src"/"v482_source_reliability_scorer.py").exists(), "src exists")
