#!/usr/bin/env python3
"""Check v489_public_record_search_planner."""
...
def main():
    print(f"Nova v489_public_record_search_planner -- Checker\n")
    c(Path(ROOT/"src"/"v489_public_record_search_planner.py").exists(), "src exists")
