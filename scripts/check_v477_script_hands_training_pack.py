#!/usr/bin/env python3
"""Check v477_script_hands_training_pack."""
...
def main():
    print(f"Nova v477_script_hands_training_pack -- Checker\n")
    c(Path(ROOT/"src"/"v477_script_hands_training_pack.py").exists(), "src exists")
    r = training_pack()
